...
public class GEXP extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.GREEN + "GEXP earned in current session: " + EnumChatFormatting.DARK_GREEN + hypermod.GEXP));
    }
}